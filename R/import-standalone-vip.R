...
# Generated by: usethis::use_standalone("bgreenwell/vip", "vip.R", ref = "d68982d6b9bc383aefbcf29ebbabecc33c06833f")
# ----------------------------------------------------------------------
#
# ---
# repo: bgreenwell/vip
...
#'
#' @param ... Additional optional arguments to be passed on to [vi][vi].
#'
...
vip.default <- function(
  ...
  imp <- imp[order(imp$Importance, decreasing = TRUE), ]  # make sure these are sorted first!
