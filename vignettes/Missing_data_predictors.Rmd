...
Now we capture the columns with missings, and create a convenience function to color the `vip()` plot output according to the missingness quality of the column
...
vip_color <- function(object, col_has_missing) {
  vip_data <- vip(object)$data %>% arrange(Importance)
